...
# === Load files ===
mask_path = Path("../../Datasets/CTC/test_images/zc2dg/fs_inference_res_cpsam/infer_000_label.tiff")
center_path = Path("../../Datasets/CTC/test_images/zc2dg/fs_inference_cellcenters/infer_000_cellcenter.tiff")
...
# === Save result ===
save_path = Path("../../Datasets/CTC/test_images/zc2dg/fs_inference_res_cpsam_masked/infer_000_label.tiff")
